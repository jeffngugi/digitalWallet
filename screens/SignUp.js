    ...
    return(
        ...
        >
            ...
            <View style={{marginTop:SIZES.padding*3}}>
                <Text style={{color:COLORS.lightGray, ...FONTS.body3}}>Full Name</Text>
                <TextInput
                    style={{
                ...
                <View style={{flexDirection:'row'}}>
                    ...
                    <View style={{justifyContent:'center'}}>
                         ...
                         <View style={{justifyContent:'center', marginLeft:5}}>
                                <Image source={{uri:selectedArea?.flag}} style={{width:30, height:30, resizeMode:'contain'}} resizeMode='contain'/>
                         </View>
                         <View style={{justifyContent:'center', marginLeft:5}}>
